...
from utils import tUFT_pytorch, tFT_pytorch, rss_pytorch, act_func, normalize_tensor, rss_from_rec, UFT_pytorch, FT_pytorch, nmse, ssim, psnr
...
def vaerecon(ksp, coilmaps, mode, vae_model, gt, logdir, device, writer=False, norm=1, 
    ...
    if writer:
        ...
        lik, dc = prior_value(rss , ksp, uspat, coilmaps, patchsize, parfact, nsampl, vae_model)
